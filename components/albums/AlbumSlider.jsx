...
import { EffectCoverflow, FreeMode, Thumbs, Navigation } from "swiper/modules";
          ...
          return (
            <SwiperSlide key={album.id} className="mb-12">
              <div className="w-full bg-secondary/80 rounded-[10px] flex flex-col xl:flex-row items-center p-6 xl:p-12 gap-x-12">
                {/* img */}
                <div className="hidden xl:flex w-[300px] h-[300px] xl:h-[500px] relative cursor-pointer rounded-[10px] overflow-hidden">
                  <Image
                    src={album.img}
                    fill
                    priority
      ...
      >
        {data?.map((thumb, index) => {
          return (
            ...
            >
              {/* img */}
              <div className="relative w-[195px] h-[195px] sm:w-[360px] sm:h-[360px] md:w-[240px] max-h-[240px] cursor-pointer">
                <Image
                  src={thumb.img}
                  fill
                  priority
